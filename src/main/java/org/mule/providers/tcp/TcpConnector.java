/*
 * $Id: TcpConnector.java 3798 2006-11-04 04:07:14Z aperepel $
 * --------------------------------------------------------------------------------------
...
import org.mule.providers.tcp.protocols.LlpProtocol;
...
public class TcpConnector extends AbstractServiceEnabledConnector
{
    ...
    protected String tcpProtocolClassName = LlpProtocol.class.getName();
